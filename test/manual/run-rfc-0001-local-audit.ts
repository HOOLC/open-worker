...
const REQUIRED_PACKAGE_SCRIPTS: ReadonlyArray<{
  ...
  { name: "test:e2e:feishu-mock", includes: "test/feishu-e2e.test.ts" },
...
export const RFC0001_REQUIRED_LOCAL_TEST_FILES = [
  ...
  "test/e2e-codex-runtime.test.ts",
  "test/e2e-jobs-tools.test.ts",
  "test/feishu-e2e.test.ts",
  ...
  "test/store-behavior.e2e.test.ts",
...
export const RFC0001_REQUIRED_LOCAL_EVIDENCE_PATTERNS: ReadonlyArray<{
  ...
  },
  {
    ...
    file: "test/feishu-e2e.test.ts",
    snippets: ["ignores private chats and bot/app senders without creating a Feishu session"],
  },
  {
    id: "bridge.group_session",
    file: "test/feishu-e2e.test.ts",
    snippets: ["starts a Feishu group @ mention as a persisted Codex session through the running broker"],
  },
  {
