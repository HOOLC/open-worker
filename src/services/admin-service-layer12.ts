...
import { AdminServiceLayer11 } from "./admin-service-layer11.js";
export class AdminServiceLayer12 extends AdminServiceLayer11 {
  privateServiceInfo(): Record<string, unknown> {
    return {
  ...
  async privateReadOperationPreflight(operation: string): Promise<OperationPreflight> {
