...
impl SessionSelection {
    pub fn is_auto(&self) -> bool {
        self.profile_id.is_empty() || self.profile_id == "auto"
    }
}
...
/// Inline image returned by a tool. Encoded once and shared across projections.
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
...
pub struct ProviderMessage {
    ...
    pub content: Arc<str>,
    pub is_error: bool,
    /// Set only by projection for a runtime-generated assistant tool call.
    /// Missing provider context or a familiar call name/ID is not provenance.
    #[serde(default)]
