...
/// Bounded execution history, separate from delivered conversation messages.
#[derive(Clone, Debug, Default, Deserialize, Eq, PartialEq, Serialize)]
#[serde(deny_unknown_fields)]
...
pub use snapshot::{
    ...
    SessionAggregates, SessionExecution, SessionSnapshot, SessionUsage,
};

/// Current session state, independent of the requested history cursor.
