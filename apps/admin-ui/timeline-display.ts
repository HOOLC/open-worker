import { summarizeInputTraceDisplay } from "./input-trace-summary";
  ...
  switch (type) {
    ...
    case "agent_assistant_message": {
      ...
      return {
        badgeLabel,
        title: rawTitle,
        summary: isGenericAssistantSummary(rawSummary) ? "" : rawSummary,
      };
    }
